      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-lg line-through text-gray-400">$150</div>
                  <div className="text-xs text-green-400 font-semibold">SALE</div>
                </div>
              </div>
            </div>
            <button 
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
            <div className="flex items-center mb-4">
              <Globe size={32} className="text-green-400 mr-4" />
              <h3 className="text-2xl font-bold text-white">Student Portfolio</h3>
            </div>
            <p className="text-gray-300 mb-4">
              Perfect for students! Get your professional portfolio with a .me, .tech, or .software domain to showcase your projects and skills.
            </p>
            <ul className="text-gray-300 space-y-2 mb-6">
              <li className="flex items-center">
                <div className="w-2 h-2 bg-green-400 rounded-full mr-3"></div>
            ...
            <div className="bg-green-500/20 rounded-lg p-4 mb-4">
              ...
              <div className="text-sm text-gray-300">One-time setup</div>
            </div>
            <button 
              onClick={() => {
                setActiveSection('contact');
